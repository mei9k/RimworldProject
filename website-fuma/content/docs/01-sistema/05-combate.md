...
> Nota para DJ: las reglas de creación, balance y uptier de armas se documentan en [Diseño y balance de armas](08-diseno-y-balance-de-armas.md).
...
Resumen operativo. Para detalle completo, ver [Daño y curación](06-danio-y-curacion.md).
